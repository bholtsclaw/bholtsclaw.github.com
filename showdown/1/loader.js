...
$.ready(function() {
  ...
  $.getScript('http://bholtsclaw.github.com/showdown/1/full.min.js?ver=42', function() {
      ...
      start: var b=new Date(2012, 5, 18, 0, 0, 0, 1);,
      end: var c=new Date(2012, 6, 9, 23, 59, 0, 0);,
      startText: '',
      endText: ''
    });
